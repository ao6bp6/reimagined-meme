/* Final Project for ESLAB, 2019 Fall , NTUEE
   ...
   Author & Development
   2020.1.04
   New Feature : Proximity, PWMout LED, OnDataWritten_Response, Feedback
 */
...
public:
    ...
    CanService(BLE &_ble, float humidInitial, float tempInitial, float gasInitial , bool feedbackInitial, float proxInitial) :
        ble(_ble),
    ...
    void InitialFeedback(bool newData){
        ble.gattServer().write(feedback.getValueHandle(),(uint8_t *)&newData,sizeof(bool));
    }
...
private:
    ...
    ReadWriteGattCharacteristic<bool> feedback;
...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *params) {
        ...
        _can_service = new CanService(_ble , 0 , 0 , 0 , false , 0 ); 
    ...
    void start_advertising() {
        ...
        ble::AdvertisingParameters adv_parameters(
            ...
            ble::adv_interval_t(ble::millisecond_t(5000))
        );

        // UpdateSensorValue
        Dist.get_distance(&TOF_Distance);
        UpdateSensorValue();
    ...
    void UpdateSensorValue(void){
        ...
        _can_service->updateProx((float)TOF_Distance);
    }
    void blink(void) {       
        _led1 = !_led1;
    }
...
private:
    ...
    void onDataWritten(const GattWriteCallbackParams *context){
        ...
        _event_queue.call(printf,"STM32 has been written!\n");
